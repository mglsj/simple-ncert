...
source: lefl112
---
import { Card, Figure, SourceButton } from "@/components/markdown";

<Card id="poet" title="About the poet">
[Pablo Neruda](https://en.wikipedia.org/wiki/Pablo_Neruda) (1904-1973) 
is the pen name of Neftali Ricardo Reyes Basoalto who
was born in the town of [Parral](https://en.wikipedia.org/wiki/Parral,_Chile) 
in Chile. Neruda's poems are full of easily
understood images which make them no less beautiful. He won the 
[Nobel Prize for Literature](https://en.wikipedia.org/wiki/1971_Nobel_Prize_in_Literature) 
in the year 1971. In this poem Neruda talks about the necessity of
