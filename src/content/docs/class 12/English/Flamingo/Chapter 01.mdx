...
French districts of [Alsace and Lorraine](https://en.wikipedia.org/wiki/Alsace%E2%80%93Lorraine) have passed into Prussian hands. Read
...
<Figure id="1.2" halfWidth={true} invertible={true}>
![](./res/fig_1.2.png)
</Figure>
...
<Figure id="1.3" halfWidth={true} invertible={true}>
![](./res/fig_1.3.png)
</Figure>
...
<Figure id="1.4" title="France, 1870-71, Sketch map not to scale" invertible={true}>
![](./res/fig_1.4.png)
</Figure>
...
<Figure id="1.5" halfWidth={true} invertible={true}>
![](./res/fig_1.5.png)
</Figure>
