---
title: Prose 7. The Interview
source: lefl107
---

import { Card, Figure, Think, Dialogue } from "@/components/markdown";

From the Introduction to The Penguin Book of Interviews edited by Christopher
Silvester.

<Card id="author" title="About the author">

[Christopher Silvester](https://www.christophersilvester.com/about) (1959) 
was a student of history at 
[Peterhouse, Cambridge](https://en.wikipedia.org/wiki/Peterhouse%2C_Cambridge).
He was a reporter for [Private Eye](https://en.wikipedia.org/wiki/Private_Eye) 
for ten years and has written features for
[Vanity Fair](https://en.wikipedia.org/wiki/Vanity_Fair_(magazine)). Following is an excerpt taken from his introduction to the 
**[Penguin Book of Interviews, An Anthology from 1859 to the Present Day](https://archive.org/details/penguinbookofint0000unse_w7o1)**.
...
then one is stealing that person's soul. V. S. Naipaul[^1] 'feels that some
...
and amusement. Rudyard Kipling[^2] expressed an even more condemnatory attitude
...
G. Wells[^3] in an interview in 1894 referred to 'the interviewing ordeal', but
was a fairly frequent interviewee and forty years later found himself
interviewing Joseph Stalin[^4]. Saul Bellow[^5], who has consented to be
...
[^1]: Known as a cosmopolitan writer. In his travel books and in his documentary
...
[^2]: A prolific writer who was known as the poet of the common soldier.
...
[^3]: An English novelist, journalist, sociologist and historian he is known for
...
[^5]: A playwright as well as a novelist, Bellow's works were influenced widely
...
Mukund Padmanabhan from _The Hindu_. Umberto Eco, a professor at the University
...
equivalent of intellectual superstardom with the publication of _The Name of the
Rose_, which sold more than 10 million copies.

<Dialogue speaker="Mukund">
...
<Dialogue speaker="Umberto Eco" align="right">
...
have already written an article! (_Laughs_).
</Dialogue>
...
_[The teacher should be able to help the pupils in what to include and what can
be omitted. We could also provide a short report of an interview as a sample.]_
