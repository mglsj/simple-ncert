---
title: Prose 2. Lost Spring
source: lefl102
---

import { Card, Figure } from "@/components/markdown";

<Card id="author" title="About the author">
[Anees Jung](https://en.wikipedia.org/wiki/Anees_Jung) (1944) was born in 
[Rourkela](https://en.wikipedia.org/wiki/Rourkela) and spent her childhood
...
[Lost Spring, Stories of Stolen Childhood](https://openlibrary.org/books/OL10100114M/Lost_Spring). 
...
### _'Sometimes I find a Rupee in the garbage'_
...
<Figure id="fig_2.1" invertable={true}>
![](./res/fig_2.1.png)
</Figure>
...
<Figure id="fig_2.2" halfWidth={true} invertable={true}>
![](./res/fig_2.2.png)
</Figure>
...
<Figure id="fig_2.3" halfWidth={true} invertable={true}>
![](./res/fig_2.3.png)
</Figure>
...
- _Hyperbole_ is a way of speaking or writing that makes something sound better
  or more exciting than it really is. For example: Garbage to them is gold.
- A _Metaphor_, as you may know, compares two things or ideas that are not very
...
- _Simile_ is a word or phrase that compares one thing with another using the
  words “like” or “as”. For example: As white as snow.

_Carefully read the following phrases and sentences taken from the text. Can you
identify the literary device in each example?_
...
_You never see the poor in this town. By day they toil, working cranes and
...
(As reported in [THE CONVERSATION](https://theconversation.com/why-a-cashless-society-would-hurt-the-poor-a-lesson-from-india-79735), 
...
through [Digital India Programme](https://en.wikipedia.org/wiki/Digital_India)? Interview some people working in unorganized
