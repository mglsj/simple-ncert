...
```
```ansi
[35m[1mValueError[0m: [35mLength of passed values is 4, index implies 3[0m
```
</Card>
...
<td>
Returns the first n members of the series. If
...
<td>
Returns the last n members of the series. If
the value for n is not passed, then by default
...
<table>
  <tr>
    <th></th>
    <th></th>
    <th colspan="3" style="text-align: center;"> Column Indexes</th>
  </tr>
  <tr>
    <th></th>
    <th></th>
    <th>State</th>
    <th>Geographical Area (sq Km)</th>
    <th>Area under Very Dense Forests (sq Km)</th>
  </tr>
  <tr>
    <td rowspan="3" style="
      ...
      ">
      <p style="transform: rotate(180deg);"><b>Row Index</b></p>
    </td>
    <td>
      1
    </td>
...
array(
    [
        [7.8438e04, 3.8852e04, 1.4830e03],
        [2.7970e03, 1.6630e03, 6.7200e00],
        [1.0192e04, 9.4070e03, 5.6240e01],
        [1.5116e04, 9.2510e03, 1.2945e02],
    ]
)
```
</td>
