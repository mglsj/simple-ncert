...
import { Example, Figure, Quote, Card, Think, Table } from "@/components/markdown";
...
classified by various parameters for India, States and Union Territories, 2011”.
...
7. <Card title="Group data as per the requirement.">
   ...
   'Adolescent (10-19)', 'All Ages', 'Youth (15-24)'. print(df1)
