...
<IdCard id="quote">
    ...
    the code messy with unprincipled optimization. Clean code does one thing well."_
    <br/>
...
- [Syntax Errors](#12-syntax-errors)
- [Exceptions](#13-exceptions)
- [Built-in Exceptions](#14-built-in-exceptions)
- [Raising Exceptions](#15-raising-exceptions)
- [Handling Exceptions](#16-handling-exceptions)
- [Finally Clause](#17-finally-clause)
...
<Figure id="figure-11" title="Figure 1.1: A syntax error displayed in Python shell mode">
...
mode as shown in [Figure 1.2](#figure-12), a dialog box specifying the name of the error
([Figure 1.3](#figure-13)) and a small description about the error is displayed.

<Figure id="figure-12" title="Figure 1.2: An error in the script ">
...
<Figure id="figure-13" title="Figure 1.3: Error dialog box">
  <center>
    ![Error dialog box](./fig_1.3.png)
  </center>
</Figure>
...
It is to be noted that `SyntaxError` shown at [Figures 1.1](#figure-11) and [1.3](#figure-13) is also an
...
<IdCard id="table-11" title="Table 1.1 Built-in exceptions in Python">
...
[Figure 1.4](#figure-14) shows the built-in exceptions viz, `ZeroDivisionError`, `NameError`, and
`TypeError` raised by the Python interpreter in different situations.

<Figure id="figure-14" title="Figure 1.4: Example of built-in exceptions">
...
<Figure id="figure-15" title="Figure 1.5: Use of the raise statement to throw an exception">
```ansi title="Python 3.13 (64-bit)"
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
...
Consider the example given in [Figure 1.6](#figure-16) that uses the `raise` statement to
...
In [Figure 1.6](#figure-16), since the value of variable length is greater than the length of
...
As we can see in [Figure 1.6](#figure-16), in addition to the error message displayed, Python
...
1.6](#figure-16), the error has been encountered in the most recently called function that
has been executed.

<Figure id="figure-16" title="Figure 1.6: Use of raise statement with built-in exception">
```ansi title="Python 3.13 (64-bit)"
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
...
exception. Consider the code given in [Program 1-1](#program-11).

import program_11 from './program_1.1.py?raw';
...
<Figure id="figure-17" title="Figure 1.7: Output of Program 1-1">
...
`"OOPS…. Negative Number"`. The output of the code is shown in [Figure 1.7](#figure-17).
...
The flowchart in [Figure 1.8](#figure-18) describes the exception handling process.
...
>
  <center>
    ![Steps of handling exception](./fig_1.8.png)
  </center>
</Figure>

{/* ```mermaid
flowchart TD
    A["An error encountered in a method"] --> B["Create exception object"]
    B --> C["Exception is raised"]
    C --> D["Runtime system searches for exception handler in the current method"]

    D -->|Found| E["Executes the code<br>(Catching an Exception)"]
    D -->|Not Found| F["Searches for methods in call stack in reverse sequence<br>(Forwarding the exception)"]

    F -->|Found| E
    F -->|Not Found| G["Program terminates"]

    class A,B,C,D,E,F,G process;
    class ThrowingException external
``` */}
...
Consider the [Program 1-2](#program-12) given below:

import program_12 from './program_1.2.py?raw';
...
In [Program 1-2](#program-12), the `ZeroDivisionError` exception is handled. If the user enters
any non-zero value as denominator, the quotient will be displayed along with the
message "`Division performed successfully`", as shown in [Figure 1.10](#figure-110). The except
...
[Figure 1.11](#figure-111). Thereafter, the statement following the try..except block is
executed and the message "`OUTSIDE try..except block`" is displayed in this case
also.

<Figure id="figure-19" title="Figure 1.9: Output without an error">
...
<Figure id="figure-110" title="Figure 1.10: Output with exception raised">
...
single try block as shown in the [Program 1-3](#program-13).

import program_13 from './program_1.3.py?raw';
...
clause of the `try..except` block. The [Program 1-4](#program-14) given below along with the
output given in [Figure 1.11](#figure-111) explains this.

import program_14 from './program_1.4.py?raw';
...
<Figure id="figure-111" title="Figure 1.11: Output of Program 1-4">
```ansi title="Python 3.13 (64-bit)" {5-8}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
...
1-5](#program-15) along with its output explains the use of `else` block with the
`try...except` block.

import program_15 from './program_1.5.py?raw';
...
<Figure id="figure-112" title="Figure 1.12: Output of Program 1-5">
```ansi title="Python 3.13 (64-bit)" {5-8}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
...
import program_16 from './program_1.6.py?raw';
...
[Program 1-7](#program-17) to understand these concepts.

import program_17 from './program_1.7.py?raw';
...
re-raised. The output of [Program 1-7](#program-17) is shown in [Figure 1.13](#figure-113).

<Figure id="figure-113" title="Figure 1.12: Output of Program 1-7">
