...
<Quote author="Bjarne Stroustrup" href="https://en.wikipedia.org/wiki/Bjarne_Stroustrup">
...
- [Syntax Errors](#section-1.2)
- [Exceptions](#section-1.3)
- [Built-in Exceptions](#section-1.4)
- [Raising Exceptions](#section-1.5)
- [Handling Exceptions](#section-1.6)
- [Finally Clause](#section-1.7)
...
<Figure 
  id="1.1" 
  title="Figure 1.1: A syntax error displayed in Python shell mode"
>
```ansi title="Python 3.13 (64-bit)"
...
mode as shown in [Figure 1.2](#figure-1.2), a dialog box specifying the name of the error
([Figure 1.3](#figure-1.3)) and a small description about the error is displayed.

<Figure id="1.2" title="Figure 1.2: An error in the script ">
```python title="Error in the script"
def test():
    marks=20
    if marks>10:
      print "GOOD SCORE"
...
<Figure id="1.3" title="Figure 1.3: Error dialog box">
  <center>
    ![Error dialog box](./res/fig_1.3.png)
  </center>
</Figure>

## 1.3 Exceptions ||section-1.3||
...
It is to be noted that `SyntaxError` shown at [Figures 1.1](#figure-1.1) and [1.3](#figure-1.3) is also an
exception. But, all other exceptions are generated when a program is
syntactically correct.

## 1.4 Built-In Exceptions ||section-1.4||
...
exceptions that can be raised in Python are explained in [Table 1.1](#table-11).

<Table id="1.1" title="Table 1.1 Built-in exceptions in Python">
...
[Figure 1.4](#figure-1.4) shows the built-in exceptions viz, `ZeroDivisionError`, `NameError`, and
`TypeError` raised by the Python interpreter in different situations.

<Figure id="1.4" title="Figure 1.4: Example of built-in exceptions">
```ansi title="Python 3.13 (64-bit)" {3,9,15}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0mprint (50/0)
Traceback (most recent call last):
  File [35m"<python-input-0>"[0m, line [35m1[0m, in [35m<module>[0m
    print ([31m50[0m[31m[1m/[0m[31m0[0m)
           [31m~~[0m[31m[1m^[0m[31m~[0m
[35m[1mZeroDivisionError[0m: [35mdivision by zero[0m
[35m[1m>>> [0mprint (var+40)
Traceback (most recent call last):
  File [35m"<python-input-1>"[0m, line [35m1[0m, in [35m<module>[0m
    print ([31m[1mvar[0m+40)
           [31m[1m^^^[0m
[35m[1mNameError[0m: [35mname 'var' is not defined. Did you mean: 'vars'?[0m
[35m[1m>>> [0m10+'5'
Traceback (most recent call last):
  File [35m"<python-input-2>"[0m, line [35m1[0m, in [35m<module>[0m
    [31m10[0m[31m[1m+[0m[31m'5'[0m
    [31m~~[0m[31m[1m^[0m[31m~~~[0m
[35m[1mTypeError[0m: [35munsupported operand type(s) for +: 'int' and 'str'[0m
[35m[1m>>> [0m
```
</Figure>
...
## 1.5 Raising Exceptions ||section-1.5||
...
### 1.5.1 The `raise` Statement ||section-1.5.1||
...
raised. For example, when an exception is raised as shown in [Figure 1.5](#figure-15), the
message `"OOPS : An Exception has occurred"` is displayed along with a brief
description of the error.

<Figure 
  id="1.5" 
  title="Figure 1.5: Use of the raise statement to throw an exception"
>
```ansi title="Python 3.13 (64-bit)"
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0mraise Exception ("OOPS!! An Exception has occured")
Traceback (most recent call last):
  File [35m"<python-input-0>"[0m, line [35m1[0m, in [35m<module>[0m
    raise Exception ("OOPS!! An Exception has occured")
[35m[1mException[0m: [35mOOPS!! An Exception has occured[0m
[35m[1m>>> [0m
```
</Figure>

The error detected may be a built-in exception or may be a user-defined one.
Consider the example given in [Figure 1.6](#figure-1.6) that uses the `raise` statement to
...
In [Figure 1.6](#figure-1.6), since the value of variable length is greater than the length of
...
As we can see in [Figure 1.6](#figure-1.6), in addition to the error message displayed, Python
...
1.6](#figure-1.6), the error has been encountered in the most recently called function that
has been executed.

<Figure 
  id="1.6" 
  title="Figure 1.6: Use of raise statement with built-in exception">
```ansi title="Python 3.13 (64-bit)"
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0mnumber=[40,50,60,70]
[35m[1m>>> [0mlength=10
[35m[1m>>> [0mif length>len(number):
[35m[1m... [0m    raise IndexError
[35m[1m... [0m    print ("NO EXECUTION")
[35m[1m... [0melse:
[35m[1m... [0m    print(length)
[35m[1m... [0m    
Traceback (most recent call last):
  File [35m"<python-input-2>"[0m, line [35m2[0m, in [35m<module>[0m
    raise IndexError
[35m[1mIndexError[0m
```
</Figure>
...
We will learn about Stack in [Chapter 3](../chapter-3).

:::

### 1.5.2 The `assert` Statement ||section-1.5.2||
...
exception. Consider the code given in [Program 1-1](#program-1.1).

import program_1_1 from './res/program_1.1.py?raw';

<Program
  id="program-11"
  title="Program 1-1: Use of assert statement"
  code={program_1_1}
/>

<Figure id="1.7" title="Figure 1.7: Output of Program 1-1">
```ansi title="Python 3.13 (64-bit)" {5-16}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
= RESTART: ...\class 12\Computer Science\program_1.1.py
use of assert statement
10000
None
Traceback (most recent call last):
  File [35m"...\class 12\Computer Science\program_1.1.py"[0m, 
    line [35m10[0m, in [35m<module>[0m
    print([31mnegativecheck[0m[31m[1m(-350)[0m)
          [31m~~~~~~~~~~~~~[0m[31m[1m^^^^^^[0m
  File [35m"...\class 12\Computer Science\program_1.1.py"[0m,
    line [35m5[0m, in [35mnegativecheck[0m
    assert [31m[1mnumber >= 0[0m, "OOPS... Negative Number"
           [31m[1m^^^^^^^^^^^[0m
[35m[1m>>> [0m
```
</Figure>
...
`"OOPS…. Negative Number"`. The output of the code is shown in [Figure 1.7](#figure-1.7).

## 1.6 Handling Exceptions ||section-1.6||
...
### 1.6.1 Need for Exception Handling ||section-1.6.1||
...
### 1.6.2 Process of Handling Exception ||section-1.6.2||

When an error occurs, Python interpreter creates an object called the _**exception
object**_. This object contains information about the error like its type, file
...
_**exception handler**_ that can handle the raised exception. It first searches for
...
The flowchart in [Figure 1.8](#figure-1.8) describes the exception handling process.

<Figure 
  id="1.8" 
  title="Figure 1.8: Steps of handling exception"
  invertable={true}
>
  <center>
    ![Steps of handling exception](./res/fig_1.8.png)
  </center>
</Figure>

### 1.6.3 Catching Exceptions ||section-1.6.3||
...
Consider the [Program 1-2](#program-1.2) given below:

import program_1_2 from './res/program_1.2.py?raw';

<Program
  id="1.2"
  title="Program 1-2 Using try..except block"
  code={program_1_2}
/>

In [Program 1-2](#program-1.2), the `ZeroDivisionError` exception is handled. If the user enters
any non-zero value as denominator, the quotient will be displayed along with the
message "`Division performed successfully`", as shown in [Figure 1.10](#figure-1.10). The except
...
[Figure 1.11](#figure-1.11). Thereafter, the statement following the try..except block is
executed and the message "`OUTSIDE try..except block`" is displayed in this case
also.

<Figure id="1.9" title="Figure 1.9: Output without an error">
```ansi title="Python 3.13 (64-bit)" {5-8}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
= RESTART: ...\class 12\Computer Science\program_1.2.py
...
<Figure id="1.10" title="Figure 1.10: Output with exception raised">
```ansi title="Python 3.13 (64-bit)" {5-7}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
= RESTART: ...\class 12\Computer Science\program_1.2.py
...
single try block as shown in the [Program 1-3](#program-1.3).

import program_1_3 from './res/program_1.3.py?raw';

<Program
  id="1.3"
  title="Program 1-3 Use of multiple except clauses"
  code={program_1_3}
/>
...
clause of the `try..except` block. The [Program 1-4](#program-1.4) given below along with the
output given in [Figure 1.11](#figure-1.11) explains this.

import program_1_4 from './res/program_1.4.py?raw';

<Program
  id="program-14"
  title="Program 1-4 Use of except without specifying an exception"
  code={program_1_4}
/>
...
<Figure 
  id="1.11" 
  title="Figure 1.11: Output of Program 1-4"
>
```ansi title="Python 3.13 (64-bit)" {5-8}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
= RESTART: ...\class 12\Computer Science\program_1.4.py
Handling exceptions without naming them
Enter the denominator0
OOPS.....SOME EXCEPTION RAISED
unrecognized DEC mode: 9001
[35m[1m>>> [0m
```
</Figure>

### 1.6.4 `try...except...else` clause ||section-1.6.4||
...
1-5](#program-1.5) along with its output explains the use of `else` block with the
`try...except` block.

import program_1_5 from './res/program_1.5.py?raw';

<Program
  id="1.5"
  title="Program 1-5 Use of else clause"
  code={program_1_5}
/>

<Figure id="1.12" title="Figure 1.12: Output of Program 1-5">
```ansi title="Python 3.13 (64-bit)" {5-8}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
= RESTART: ...\class 12\Computer Science\program_1.5.py
...
## 1.7 `finally` clause ||section-1.7||
...
import program_1_6 from './res/program_1.6.py?raw';

<Program
    id="1.6"
    title="Program 1-6 Use of finally clause"
    code={program_1_6}
/>
...
### 1.7.1 Recovering and continuing with `finally` clause ||section-1.7.1||
...
re-raised after the execution of the `finally` block. For example, [Program 1-4](#program-14)
...
[Program 1-7](#program-1.7) to understand these concepts.

import program_1_7 from './res/program_1.7.py?raw';

<Program
  id="1.7"
  title="Program 1-7 Recovering through finally clause"
  code={program_1_7}
/>
...
re-raised. The output of [Program 1-7](#program-1.7) is shown in [Figure 1.13](#figure-1.13).

<Figure id="1.13" title="Figure 1.12: Output of Program 1-7">
```ansi title="Python 3.13 (64-bit)" {5-11}
Python 3.13.0 (tags/v3.13.0:60403a5, Oct  7 2024, 09:38:07) [MSC v.1941 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
[35m[1m>>> [0m
= RESTART: ...\class 12\Computer Science\program_1.7.py
 Practicing for try block
Enter the denominatorvar
OVER AND OUT
Traceback (most recent call last):
  File [35m"...\class 12\Computer Science\program_1.7.py"[0m, line [35m4[0m, 
    in [35m<module>[0m denom = int(input("Enter the denominator"))
[35m[1mValueError[0m: [35minvalid literal for int() with base 10: 'var'[0m
[35m[1m>>> [0m
```
</Figure>
