...
---
import { Card, Code, LinkButton } from '@astrojs/starlight/components';

<Card>
    _I like my code to be elegant and efficient. The logic should be
...
<div id="table-11">
    <Card title="Table 1.1 Built-in exceptions in Python">
...
<div id="program-11">
    <Code title="Program 1-1: Use of assert statement" lang="python" code={program_11}/>
</div>

<LinkButton 
    href="https://marimo.app/l/7fnw4k"
    icon="external"
    iconPlacement="start"
>
    Run Code
...
<div id="program-12">
    <Code title="Program 1-2 Using try..except block" lang="python" code={program_12}/>
</div>
...
<div id="program-13">
    <Code title="Program 1-3 Use of multiple except clauses" lang="python" code={program_13}/>
</div>
...
<div id="program-14">
    <Code title="Program 1-4 Use of except without specifying an exception" lang="python" code={program_14}/>
</div>
...
<div id="program-15">
    <Code title="Program 1-5 Use of else clause" lang="python" code={program_15}/>
</div>
...
<div id="program-16">
    <Code title="Program 1-6 Use of finally clause" lang="python" code={program_16}/>
</div>
...
<div id="program-17">
    <Code title="Program 1-7 Recovering through finally clause" lang="python" code={program_17}/>
</div>
...
re-raised. The output of [Program 1-7](#program-17) is shown in Figure 1.13.
