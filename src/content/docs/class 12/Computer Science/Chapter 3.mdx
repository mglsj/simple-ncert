...
<Figure id="figure-31" title="Figure 3.1: Stack of plates and books">
  <centre>
...
<Figure id="figure-32" title="Figure 3.2: PUSH and POP operations on the stack of glasses">
  <centre>
...
<Figure id="figure-33" title="Figure 3.3: Conversion of infix expression (x + y)/(z*8) to postfix notation">
  <centre>
    ![](./fig_3.3.a.webp)
    ![](./fig_3.3.b.png)
  </centre>
...
<Figure id="figure-34" title="Figure 3.4: Evaluation of postfix expression 7 8 2 * 4 / +">
  <centre>
