...
<Activity title="Activity 5.1">
[Algorithm 5.1](#algorithm-5.1) sorts a list in ascending order. Write a bubble sort algorithm to
sort a list in descending order?
</Activity>

import program_5_1 from './res/program_5.1.py?raw';
import output_5_1 from './res/output_5.1.txt?raw';
...
import program_5_2 from './res/program_5.2.py?raw';
import output_5_2 from './res/output_5.2.txt?raw';
...
import program_5_3 from './res/program_5.3.py?raw';
import output_5_3 from './res/output_5.3.txt?raw';
