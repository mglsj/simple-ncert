...
Figure 1.4 shows the built-in exceptions viz, ZeroDivisionError, NameError, and
...
We will learn about Stack in Chapter 3.
...
```py title="Program 1-4 Use of except without specifying an exception"
