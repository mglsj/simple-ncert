...
<Figure id="9.4" title="Figure 9.4: Union of two sets" halfWidth={true} invertible={true}>
...
<Figure id="9.5" title="Figure 9.5: Intersection of two sets" halfWidth={true} invertible={true}>
...
<Figure id="9.6" title="Figure 9.6: Difference of two sets" halfWidth={true} invertible={true}>
