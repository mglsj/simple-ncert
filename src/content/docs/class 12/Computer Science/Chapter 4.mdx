...
<SourceButton source="lecs104"/>

<IdCard id="quote">
  _"We could say we want the Web to reflect a vision of the world where
  everything is done democratically. To do that, we get computers to talk with
  each other in such a way as to promote that ideal."_
  <br/>
...
- [Introduction to Queue](#41-introduction-to-queue)
- [Operations on Queue](#42-operations-on-queue)
- [Implementation of Queue using Python](#43-implementation-of-queue-using-python)
- [Introduction to Deque](#44-introduction-to-deque)
- [Implementation of Deque using Python](#45-implementation-of-deque-using-python)
...
([Figure 4.1](#figure-41)), vehicles queued at fuel pumps ([Figure 4.2](#figure-42)), etc.

<Figure id="figure-41" title="Figure 4.1: Queue of people at a bank">
  <centre>
    ![Queue of people at a bank](./fig_4.1.webp)
  </centre>
</Figure>

<Figure id="figure-42" title="Figure 4.2: Queue of cars in a petrol pump">
  <centre>
    ![Queue of cars in a petrol pump](./fig_4.2.webp)
  </centre>
</Figure>
...
[Figure 4.3](#figure-43) shows the various stages of a simple queue containing alphabets. In
the figure, Front of the queue is on the left and Rear on the right.

<Figure id="figure-43" title="Figure 4.3: Various Stages of Stack Operations">
  <centre>
    ![Various Stages of Stack Operations](./fig_4.3.webp)
  </centre>
</Figure>
...
import program_41 from './program_4.1.py?raw';
import output_41 from './output_4.1.txt?raw';
...
<Figure id="figure-44" title="Figure 4.4: Basic deque structure displaying head and tail to implement stack or queue.">
  <centre>
    ![Basic deque structure displaying head and tail to implement stack or queue.](./fig_4.4.webp)
  </centre>
</Figure>
...
<IdCard id="algorithm-41" title="Algorithm 4.1">
  <Steps>
...
3. REPEAT Step 1 and Step 2 for all characters of string (madam)
   <Figure id="figure-45" title="Figure 4.5: Status of Deque after 4th iteration">
    <centre>
    ![Status of Deque after 4th iteration](./fig_4.5.webp)
    </centre>
   </Figure>
...
4. Remove one character from the front and one character from the rear end of
   ...
   <Figure id="figure-46" title="Figure 4.6: Status of Deque after removing one character from both the ends.">
    <centre>
    ![Status of Deque after removing one character from both the ends.](./fig_4.6.webp)
    </centre>
   </Figure>
...
import program_42 from './program_4.2.py?raw';
import output_42 from './output_4.2.txt?raw';
...
(**Hint**: refer to [algorithm 4.1](#algorithm-41))
