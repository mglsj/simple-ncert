...
<SourceButton source="lhmh101"/>

<IdCard id="quote">
  _There is no permanent place in the world for ugly mathematics ... . It may be
  ...
  does not prevent us from recognising one when we read it._
...
## 1.1 भूमिका (Introduction) ||11-introduction||
...
- (iv) $\{(a, b) ∈ A × B:$ पिछली अंतिम परीक्षा में $a$ द्वारा प्राप्त पूर्णांक $b$ द्वारा
  प्राप्त पूर्णांक से कम है$\}$,
- (v) $\{(a, b) ∈ A × B: a$ उसी जगह रहता है जहाँ $b$ रहता है $\}$. तथापि $A$ से $B$
  तक के किसी संबंध $R$ को अमूर्तरूप (Abstracting) से हम गणित में $A × B$ के एक स्वेच्छ
...
### 1.2 संबंधों के प्रकार (Types of Relations) ||12-types-of-relations||

इस अनुच्छेद में हम विभिन्न प्रकार के संबंधों का अध्ययन करेंगे। हमें ज्ञात है कि किसी समुच्चय $A$ में
संबंध, $A × A$ का एक उपसमुच्चय होता है। अत: रिक्त समुच्चय $φ ⊂ A × A$ तथा $A × A$ स्वयं,
...
$R' = \{(a, b) : | a – b | ≥ 0\}$, संपूर्ण समुच्चय $A × A$ के तुल्य है, क्योंकि $A × A$ के
सभी युग्म $(a, b), | a – b | ≥ 0$ को संतुष्ट करते हैं। यह दोनों अन्त्य के उदाहरण हमें
निम्नलिखित परिभाषाओं के लिए प्रेरित करते हैं।

<IdCard>

#### परिभाषा 1 ||definition-1||

A relation $R$ in a set $A$ is called _**empty relation**_, if no element of $A$
is related to any element of $A$, i.e., $R = φ ⊂ A × A$.

समुच्चय $A$ पर परिभाषित संबंध $R$ एक _**रिक्त संबंध**_ कहलाता है, यदि $A$ का कोई भी अवयव $A$ के किसी भी अवयव से संबंधित नहीं है, अर्थात् $R = φ ⊂ A × A$. 

</IdCard>

<IdCard>

#### परिभाषा 2 ||definition-2||

समुच्चय $A$ पर परिभाषित संबंध $R$, एक _**सार्वत्रिक (universal) संबंध**_ कहलाता है, यदि $A$ का प्रत्येक अवयव $A$ के सभी अवयवों से संबंधित है, अर्थात् $R = A × A$. 
...
प्रश्नानुसार, क्योंकि स्कूल बालकों का है, अतएव स्कूल का कोई भी विद्यार्थी, स्कूल के किसी भी विद्यार्थी की बहन नहीं हो सकता है। अत: $R = φ$, जिससे प्रदर्शित होता है कि R रिक्त संबंध है। यह भी स्पष्ट है कि किन्हीं भी दो विद्यार्थियों की ऊँचाइयों का अंतर 3 मीटर से कम होना ही चाहिए। इससे प्रकट होता है कि $R' = A × A$ सार्वत्रिक संबंध है। 

</details>

:::note[टिप्पणी]

कक्षा XI में विद्यार्थीगण सीख चुके हैं कि किसी संबंध को दो प्रकार से निरूपित किया जा सकता है, नामत: रोस्टर विधि तथा समुच्चय निर्माण विधि। तथापि बहुत से लेखकों द्वारा समुच्चय $\{1, 2, 3, 4\}$ पर परिभाषित संबंध $R = \{(a, b) : b = a + 1\}$ को $a R b$ द्वारा भी निरूपित किया जाता है, यदि और केवल यदि b = a + 1 हो। जब कभी सुविधाजनक होगा, हम भी इस संकेतन (notation) का प्रयोग करेंगे। 

:::

यदि $(a, b) ∈ R$, तो हम कहते हैं कि $a,b$ से संबंधित है' और इस बात को हम $a R b$ द्वारा प्रकट करते हैं। 

एक अत्यन्त महत्वपूर्ण संबंध, जिसकी गणित में एक सार्थक (significant) भूमिका है, _**तुल्यता संबंध (Equivalence Relation)**_ कहलाता है। तुल्यता संबंध का अध्ययन करने के लिए हम पहले तीन प्रकार के संबंधों, नामत: स्वतुल्य (Reflexive), सममित (Symmetric) तथा संक्रामक (Transitive) संबंधों पर विचार करते हैं।

<IdCard>

#### परिभाषा 3 ||definition-3||

समुच्चय $A$ पर परिभाषित संबंध $R$;

- (i) _**स्वतुल्य (reflexive)**_ कहलाता है, यदि प्रत्येक $a ∈ A$ के लिए $(a, a) ∈ R$,
- (ii) _**सममित (symmetric) कहलाता है, यदि समस्त $a1, a2 ∈ A$ के लिए $(a1, a2) ∈ R$ से $(a2, a1) ∈ R$ प्राप्त हो। 
- (iii) _**संक्रामक (transitive) कहलाता है, यदि समस्त, $a1, a2, a3 ∈ A$ के लिए $(a1, a2) ∈ R$ तथा $(a2, a3) ∈ R$ से $(a1, a3) ∈ R$ प्राप्त हो। 

</IdCard>

<IdCard>

#### परिभाषा 4 ||definition-4||

$A$ पर परिभाषित संबंध $R$ एक _**तुल्यता संबंध**_ कहलाता है, यदि $R$ स्वतुल्य, सममित तथा संक्रामक है।
...
In उदाहरण 5 ||example-5||, note that all even integers are related to zero, as $(0, ± 2)$,
...
Following the arguments similar to those used in उदाहरण 5 ||example-5||, we can show that $R$
...
Show that each of the relation 4 in the set $A = \{x ∈ Z : 0 ≤ x ≤ 12\}$, given
by
...
In [Fig 1.2](#figure-12), we observe that the images of distinct elements of
$X_1$ under the function $f_1$ are distinct, but the image of two distinct
elements $1$ and $2$ of $X_1$ under $f_2$ is same, namely $b$. Further, there
are some elements like $e$ and $f$ in $X_2$ which are not images of any element
of $X1$ under $f_1$, while all elements of $X3$ are images of some elements of
$X1$ under $f_3$. The above observations lead to the following definitions:

<IdCard>

#### परिभाषा 5 ||definition-5||
...
The function $f_1$ and $f_4$ in [Fig 1.2](#figure-12) (i) and (iv) are one-one
and the function $f_2$ and $f3_3$ in [Fig 1.2](#figure-12) (ii) and (iii) are
many-one.

<IdCard>

#### परिभाषा 6 ||definition-6||
...
The function $f_3$ and $f_4$ in [Fig 1.2](#figure-12) (iii), (iv) are onto and
the function $f_1$ in [Fig 1.2](#figure-12) (i) is not onto as elements $e$, $f$
in $X_2$ are not the image of any element in $X1$ under $f_1$.
...
#### परिभाषा 7 ||definition-7||

A function $f : X → Y$ is said to be one-one and onto (or _**bijective**_), if
$f$ is both one-one and onto.

</IdCard>

The function $f_4$ in [Fig 1.2](#figure-12) (iv) is one-one and onto.

#### उदाहरण 7 ||example-7||

Let $A$ be the set of all $50$ students of Class X in a school. Let $f : A → ℕ$
