...
स्मरण कीजिए कि कक्षा XI में, संबंध् एवं पफलन, प्रांत, सहप्रांत तथा
परिसर आदि की अवधरणाओं का, विभिन्न प्रकार वेफ वास्तविक
मानीय पफलनों और उनवेफ आलेखों सहित परिचय कराया जा चुका
है। गणित में शब्द 'संबंध (Relation)' की सवंफल्पना को अंग्रेशी
भाषा में इस शब्द वेफ अर्थ से लिया गया है, जिसवेफ अनुसार दो
वस्तुएँ परस्पर संबंध्ति होती है, यदि उनवेफ बीच एक अभिज्ञेय (Recognisable) 
कड़ी हो। मान लीजिए कि $A$, किसी स्कूल की XII वेफ विद्यार्थियों का समुच्चय है तथा $B$ 
उसी स्कूल की कक्षा XI वेफ विद्यार्थियों का समुच्चय हैं। अब समुच्चय $A$ से
समुच्चय $B$ तक वेफ संबंधें वेफ वुफछ उदाहरण इस प्रकार हैं

- (i) $\{(a, b) ∈ A × B: a, b$ का भाई है$\}$,
- (ii) $\{(a, b) ∈ A × B: a, b$ की बहन है$\}$,
- (iii) $\{(a, b) ∈ A × B: a$ की आयु $b$ की आयु से अधिक है$\}$,
- (iv) $\{(a, b) ∈ A × B:$ पिछली अंतिम परीक्षा में $a$ द्वारा प्राप्त पूर्णांक $b$ द्वारा प्राप्त पूर्णांक से कम है$\}$,
- (v) $\{(a, b) ∈ A × B: a$ उसी जगह रहता है जहाँ $b$ रहता है $\}$. तथापि $A$ से $B$ तक के किसी संबंध $R$ को अमूर्तरूप (Abstracting) 
  से हम गणित में $A × B$ के एक स्वेच्छ (Arbitrary) उपसमुच्चय की तरह परिभाषित करते हैं।
...
In [Fig 1.2](#figure-12), we observe that the images of distinct elements of $X_1$ under the
...
The function $f_1$ and $f_4$ in [Fig 1.2](#figure-12) (i) and (iv) are one-one and the
function $f_2$ and $f3_3$ in [Fig 1.2](#figure-12) (ii) and (iii) are many-one.
...
The function $f_3$ and $f_4$ in [Fig 1.2](#figure-12) (iii), (iv) are onto and the function
$f_1$ in [Fig 1.2](#figure-12) (i) is not onto as elements $e$, $f$ in $X_2$ are not the image
